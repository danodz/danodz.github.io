...
"I want to hear someone say “Go play Triangle or Square and tell me this isn’t art” with a serious face (not this version, which comes with an intellectual commentary and could be considered art; I’m talking about <a href='https://danodz.github.io/smallGames/triangleOrSquare/' target='_blank'>the vanilla one</a>).",
...
"Like if Patrick from SpongeBob were to ask you if mayonnaise is a game, you should answer him that no mayonnaise is not a game. But it can be an incredible, messy game component. <div><img class='mayo' src='res/mayo.jpg'></div>",
"To give a more concrete example that uses actual game components (for people not familiar with game design terminology), in Monopoly, the dice, the board and the pawns are game components. But no one would say for example that the thimble pawn is in itself a game; it’s just a pawn (and objectively the coolest one).<div><img src='res/thimble.png'></div>",
